...
class Bot:
    ...
    def randomShips(self):
        ...
        for ship in SHIPS:
            validShip = False
            while (not validShip):
                y = random.randint(0,SIZE_TABLERO-1); x = random.randint(0,SIZE_TABLERO-1); orientation = random.randint(0,1)
        ...
        # BUILD
            ...
            for ship in SHIPS:
                ...
                while (not isValidShip):
                    ...
                    y = getCoord("x"); x = getCoord("y"); inputOrientation = getOrientation()
